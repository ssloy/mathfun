...
%Положим скорость вращения диска $D$ постоянной, угол $q_b=0$, таким образом, у нас остаётся две степени свободы: $q_c$ и $q_a$.
...
%\left(J_2 - J_1 \cos^2(q_c) - J_d\sin^2(q_c)\right)\dot \omega_a - J_1 \sin(2 q_c)\omega_c\omega_a +  J_d\sin(q_c)(\tau_d/J_d -  \cos(q_c)\omega_c\omega_a) + J_d \cos(q_c) \omega_c\omega_d &= 0
%\end{align*}
