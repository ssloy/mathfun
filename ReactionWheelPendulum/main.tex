...
Итак, у нас есть модель \eqref{eq:mechModel:generalized}. Как и в разделе \ref{sec:wheelSize:linear}, мы пренебрегаем индуктивностью и рассматриваем модель мотора вида
\[
...
Результат вычислений приведён на рисунке \ref{fig:rwdiameter:comparison}.
\begin{figure}[tb]
