...
{\bf Лемма.} Пусть $\alpha_1<1$, $\alpha_2\leqslant2\alpha_1-1$, $L\in (0,\frac{1}{\sqrt{2}})$, $M>1$; $k_1,k_2>0$, $f(t)\equiv 1$. 
Тогда существует окрестность нуля $\mathbb R^3$, в которой система \eqref{eq:1} устойчива.
...
Теперь заметим, что система \eqref{eq:1} имеет вид $\dot{\vec{e}} = A\vec{e}$, где $\vec{e} = (e_p, e_1, e_2)^\top$, а матрица выглядит следующим образом:
...
Для начала выберем окрестность нуля, где выполняется следующее неравенство: $s>\frac{1}{L}$.
...
\begin{align*}
\frac{1}{2}\frac{d}{dt} G(y_1,y_2,y_3) &= Ky_1\dot y_1 + y_2\dot y_2 + y_3\dot y_3 = \\
%& = K y_1(-p_{11}y_1 + p_{12}y_2 + p_{13}y_3) +  y_2(p_{21}y_1 - p_{22}y_2 + p_{23}y_3)+  M y_3(p_{31}y_1 + p_{32}y_2 - p_{33}y_3) \\
& = \underbrace{-Kp_{11}y_1^2}_{<-KBy_1^2}+Kp_{12}y_1y_2+Kp_{13}y_1y_3+p_{21}y_1y_2-p_{22}y_2^2+\underbrace{(p_{23}+Mp_{32})y_2y_3}_{=0}+Mp_{31}y_1y_3-Mp_{33}y_3^2  <\\
& < -KBy_1^2+Kp_{12}y_1y_2+Kp_{13}y_1y_3+p_{21}y_1y_2-p_{22}y_2^2+Mp_{31}y_1y_3-Mp_{33}y_3^2
\end{align*}
...
\begin{equation}
\label{eq:B>m^2}
B \geqslant \frac{L k_2}{k_1^2} m^2 \quad \text{for} \quad  |e_p|\leqslant 1.
\end{equation}



Also simple estimations yield
$$
|p_{21}|\leqslant \frac{m}{L}+M \qquad \text{and} \qquad |p_{31}|\leqslant m+ \frac1L\,.
$$
Therefore in a neighborhood of the origin we have:
$$
|p_{21}|\leqslant \frac{2m}{L} \qquad \text{and} \qquad |p_{31}|\leqslant 2m.
$$
Due to \eqref{eq:B>m^2} there exist a number (constant) $K$ such that
\begin{equation}
\label{eq:p21p31}
\frac{2m}{L} \leqslant 2 \sqrt{\frac{KB}{8}\frac{p_{22}}{4}} \quad \text{and} \quad 2mM \leqslant 2  \sqrt{\frac{KB}{8}\frac{M p_{33}}{4}}.
\end{equation}
First we fix this number $K$. Next we fix a neighborhood of the origin to satisfy the following:
\begin{equation}
\label{eq:p12p13}
K p_{12} \leqslant 2 \sqrt{\frac{KB}{8}\frac{p_{22}}{4}} \quad \text{and} \quad  Kp_{13} \leqslant 2  \sqrt{\frac{KB}{8}\frac{M p_{33}}{4}}.
\end{equation}
Now we claim that the function $G(y_1,y_2,y_3)=K|y_1|^2+|y_2|^2+M|y_3|^2$ is a Lyapunov function in a neighborhood of the origin.
Indeed, \eqref{eq:p21p31} and the geometric-arithmetic mean inequality $2\sqrt{xy}\leqslant x^2+y^2$ imply
$$
|p_{21}y_1y_2|\leqslant \frac{KB}{8}y_1^2+\frac{p_{22}}{4}y_2^2  \qquad \text{and} \qquad |Mp_{31}y_1y_3|\leqslant \frac{KB}{8}y_1^2+\frac{Mp_{33}}{4}y_3^2.
$$
Similarly, from \eqref{eq:p12p13} it follows that
$$
|Kp_{12}y_1y_2|\leqslant \frac{KB}{8}y_1^2+\frac{p_{22}}{4}y_2^2  \qquad \text{and} \qquad |Kp_{13}y_1y_3|\leqslant \frac{KB}{8}y_1^2+\frac{Mp_{33}}{4}y_3^2.
$$
Thus
\begin{multline}
\frac{d}{dt} G(y_1,y_2,y_3)\leqslant -KBy_1^2+Kp_{12}y_1y_2+Kp_{13}y_1y_3+p_{21}y_1y_2-p_{22}y_2^2+
\\
+(p_{23}+Mp_{32})y_2y_3+Mp_{31}y_1y_3-Mp_{33}y_3^2 \leqslant \\
\leqslant
-\frac{KB}{2}y_1^2-\frac{p_{22}}{2}y_2^2-\frac{Mp_{33}}2 y_3^2\leqslant 0.
\end{multline}
