...
\begin{equation}
\label{eq:B}
|e_p|\leqslant 1 \quad \Rightarrow \quad B \geqslant \frac{L k_2}{k_1^2} s^2 
\end{equation}
$
...
$|e_p|\leqslant 1 \Rightarrow |e_p|^{\alpha_2-1} \geq |e_p|^{2(\alpha_1-1)} \Rightarrow \frac{B}{Lk_2} \geq \left(\frac{s}{k_1}\right)^2$  
