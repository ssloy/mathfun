...
\begin{align}
|p_{21}y_1y_2|  & \leqslant \frac{KB}{8}y_1^2+\frac{p_{22}}{4}y_2^2  \label{eq:p21} \\
|Mp_{31}y_1y_3| & \leqslant \frac{KB}{8}y_1^2+\frac{Mp_{33}}{4}y_3^2 \label{eq:p31} \\
|Kp_{12}y_1y_2| & \leqslant \frac{KB}{8}y_1^2+\frac{p_{22}}{4}y_2^2  \label{eq:p12} \\
|Kp_{13}y_1y_3| & \leqslant \frac{KB}{8}y_1^2+\frac{Mp_{33}}{4}y_3^2 \label{eq:p13}
\end{align}
...
\paragraph{Факт 1: $|p_21|<2\frac{s}{L}$}
